...
public class ProducaoRepository {
    ...
    public ProducaoRepository() {
        ...
        producoes.add(new Filme("The Irishman", LocalDate.of(219,11,13), "Drama", "https://media.themoviedb.org/t/p/w440_and_h660_face/3GPn2W2UdzUE1bp1KtCrYvXiZFt.jpg", "Martin Scorsese", 4) );
